...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QRect(21, 18, 781, 901))
        self.verticalLayout = QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.websiteRadioButton = QRadioButton(self.layoutWidget)
        ...
        self.gunbrokerRadioButton = QRadioButton(self.layoutWidget)
        ...
        self.templateSelect = QComboBox(self.layoutWidget)
